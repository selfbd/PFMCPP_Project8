...
int main()
{
     ...
     */
    cars.emplace_back("Chuck's Outback");
    cars.emplace_back("Janet's BMW");

    /*
     now reserve and emplace_back your Trucks and Motorcyles
     */
    motorcycles.reserve(3);
    motorcycles.emplace_back("Michael's Triumph");
    motorcycles.emplace_back("Bill's BMW");
    motorcycles.emplace_back("Daphne's Ducati");
    
    trucks.reserve(3);
    trucks.emplace_back("Fred's Freighliner");
    trucks.emplace_back("Mack's Mack");
    trucks.emplace_back("Victor's Volvo");
